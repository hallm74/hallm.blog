---
author: hallm
pubDatetime: 2024-11-30T19:30:00
...
tags:
    - astro
    - programming
description: Since everyone has been creating Bluesky accounts, found a nice writeup on how to add it to Astropaper.  Someone has already asked if they can be assigned that part of the project in the GitHub so I imagine it'll be part of an upcoming version.
---
...
[Adding Bluesky icon to my Astro blog | amanhimself.dev](https://amanhimself.dev/blog/add-bluesky-icon-to-astropaper/)